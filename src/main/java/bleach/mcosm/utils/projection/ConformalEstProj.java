package bleach.mcosm.utils.projection;

import java.io.IOException;
import java.io.InputStream;
import java.util.Scanner;

public class ConformalEstProj extends AiroceanProj {

	public InvertableVectorField inverse;
	public static double VECTOR_SCALE_FACTOR = 1/1.1473979730192934;
	
	public ConformalEstProj() {
        InputStream is = null;
